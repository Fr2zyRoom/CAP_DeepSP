...
def run(opt):
    ...
    ## Load Data
    image_datasets, dataloaders, dataset_sizes, labtrans = load_data(BATCH_SIZE, opt.path_to_images, opt.path_to_csv)
...
def infer_run(opt):
    ...
    ## Load Data
    image_datasets, dataloaders, dataset_sizes, labtrans = load_infer_data(BATCH_SIZE, opt.path_to_images, opt.path_to_csv, opt.path_to_train_images, opt.path_to_train_csv)
